...
theme.MobileNav = (function() {
  ...
  function openMobileNav() {
    ...
    cache.$mobileNavToggle
      .addClass(classes.mobileNavCloseIcon + ' active')
  ...
  function closeMobileNav() {
    ...
    cache.$mobileNavToggle
      ...
      .removeClass(classes.mobileNavCloseIcon + ' active')
  ...
  function toggleSubNav(evt) {
    ...
    if (isReturn) {
      $(this).removeClass('opened '  + classes.return);
    } else {
      $(this).addClass('opened ' + classes.return).siblings().removeClass('opened '  + classes.return);
    }
...
$('.footer-col').each(function() {
  var $this = $(this);
  var $find_heading = $this.find('.footer_column_heading');

  if($find_heading.length){
    $find_heading.on('click', function() {
      if($(this).hasClass('id-active')){
        $(this).removeClass('id-active');
        $(this).siblings('.footer-col-content').hide();
      } else {
        $(this).addClass('id-active');
        $(this).siblings('.footer-col-content').show();
      }
    });
  }
});
...
$('body').on('click', '[data-customer-register]', function(event) {  
  event.preventDefault();
  const $thisform = $(event.currentTarget).closest('form');
  const f_name = $('[data-customer-firstname]').val();
  const l_name =  $('[data-customer-lastname]').val();
  const email = $('[data-customer-email]').val();
  const password = $('[data-customer-password]').val();
  const c_password = $('[data-customer-confirmPassword]').val();
  ...
  $('[data-customer-firstname]').keydown(function () {
    $('[data-customer-firstname]').removeClass('mage-error');
    $('#firstname-error').addClass('d-none');
  });
  $('[data-customer-lastname]').keydown(function () {
    $('[data-customer-lastname]').removeClass('mage-error');
    $('#lastname-error').addClass('d-none');
  });
  $('[data-customer-email]').keydown(function () {
    $('[data-customer-email]').removeClass('mage-error');
    $('#email_address-error').addClass('d-none');
  });
  $('[data-customer-password]').keydown(function () {
    $('[data-customer-password]').removeClass('mage-error');
    $('#password-error').addClass('d-none');
  });
  $('[data-customer-confirmPassword]').keydown(function () {
    $('[data-customer-confirmPassword]').removeClass('mage-error');
    $('#password-confirmation-error').addClass('d-none');
  });

  if (f_name == '' && l_name == '' && email == '' && password == '' && c_password == '' ){
    $(".customer_register_input").addClass('mage-error');
    $('#firstname-error').removeClass('d-none');
    $('#lastname-error').removeClass('d-none');
    $('#email_address-error').removeClass('d-none');
    $('#password-error').removeClass('d-none');
    $('#password-confirmation-error').removeClass('d-none');
  } else if (f_name == '') {
      $('[data-customer-firstname]').addClass('mage-error');
      $('#firstname-error').removeClass('d-none');
  } else if (l_name == '') {
    $('[data-customer-lastname]').addClass('mage-error');
    $('#lastname-error').removeClass('d-none');
  } else if (email == '') {
    $('[data-customer-email]').addClass('mage-error');
    $('#email_address-error').removeClass('d-none');
    $('#email_address-error').html('This is a required field.');
  } else if (email != '' && !validateEmail(email) ) {
    $('[data-customer-email]').addClass('mage-error');
    $('#email_address-error').removeClass('d-none');
    $('#email_address-error').html('Please enter a valid email address (Ex: johndoe@domain.com).');
  } else if(password == ''){
    $('[data-customer-password]').addClass('mage-error');
    $('#password-error').removeClass('d-none');
  } else if(c_password == ''){
    $('[data-customer-confirmPassword]').addClass('mage-error');
    $('#password-confirmation-error').removeClass('d-none');
    $('#password-confirmation-error').html('This is a required field.');
  } else if(c_password !== password){
    $('[data-customer-confirmPassword]').addClass('mage-error');
    $('#password-confirmation-error').removeClass('d-none');
    $('#password-confirmation-error').html('Please enter the same value again.');
   }else {
     console.log('submit');
    $('#RegisterForm').submit();
  }

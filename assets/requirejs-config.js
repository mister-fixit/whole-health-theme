    ...
    'config': {
        'mixins': {
            'Magedelight_Cybersource/js/view/payment/method-renderer/cybersource-method': {
                'Brsw_MagedelightCybersourceExt/js/view/payment/method-renderer/cybersource-method-mixin': true
            }
        }
    }
};
...
var config = {
    "map": {
        "*": {
            "Magento_Ui/js/form/element/select": "Brsw_CoreJsFix/js/form/element/select"
        }
    }
};
require.config(config);
    ...
    'config': {
        'mixins': {
            'Magento_Paypal/js/view/payment/method-renderer/paypal-express': {
                'Brsw_HidePayments/js/view/payment/method-renderer/paypal-express-mixin': true
            }
        }
    }
};
